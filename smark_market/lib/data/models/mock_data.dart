...
class MockData {
  ...
  static const List<AiRecommendation> recommendations = [
    AiRecommendation(
      ...
      description:
          'Compra arroz en Carulla y lácteos en Jumbo. Basado en tus patrones de compra.',
      type: 'saving',
      savingAmount: 22000,
      icon: '💰',
    ),
    AiRecommendation(
      ...
      description:
          'Tu última compra fue hace 5 días. Promedio de reposición: 7 días. Actualmente 10% más barata en Jumbo.',
      type: 'prediction',
      savingAmount: 320,
      icon: '🔮',
    ),
    AiRecommendation(
      ...
      description:
          'Tu carrito habitual es \$5.000 más caro en Éxito, pero Carulla queda a solo 0.8km.',
      type: 'location',
      savingAmount: 5000,
      icon: '📍',
    ),
